...
import type { ExternalBlob as _ExternalBlob, Product as _Product, ProductId as _ProductId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: ExternalBlob, arg5: boolean): Promise<ProductId> {
        if (this.processError) {
            try {
    ...
    async listOrders(): Promise<Array<OrderType>> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: ProductId, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string): Promise<OrderId> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: ExternalBlob, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        designUrl: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.designUrl),
        name: value.name,
