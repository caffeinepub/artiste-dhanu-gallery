...
export interface _SERVICE {
  ...
  'listOrders' : ActorMethod<[], Array<OrderType>>,
  'listProducts' : ActorMethod<[], Array<Product>>,
  'placeOrder' : ActorMethod<
    [ProductId, string, string, string, string, string, string, string, string],
    OrderId
  >,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'updateOrderStatus' : ActorMethod<[OrderId, string], undefined>,
  'updateProduct' : ActorMethod<
    [ProductId, string, string, bigint, string, ExternalBlob, boolean],
    undefined
  >,
}
